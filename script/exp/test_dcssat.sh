...
# ========== Check Config ===============
: "${CASEDIR:="../../testcases/test"}"         # folder of input
: "${LOGDIR:="../../exp/test/rawlog"}"                # folder to store raw log
: "${INFO_COLLECT_FILE:="../../exp/test/result.csv"}" # file to store this exp result
...
: "${ForceRun:=1}"       # 0: not solve if the rawlog exists, 1: solve even the rawlog exists
...
export TESTSCRIPT
# ====== Main Function============
bash ./_run_basic_solver_dcssat.sh
