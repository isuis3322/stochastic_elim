...
# ========== Check Config ===============
: "${CASEDIR:="../../testcases/eval08/sdimacs"}"         # folder of input
: "${LOGDIR:="../../exp/eval08-benchmarks/dcssat/rawlog"}"                # folder to store raw log
: "${INFO_COLLECT_FILE:="../../exp/eval08-benchmarks/dcssat/result.csv"}" # file to store this exp result
