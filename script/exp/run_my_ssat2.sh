...
: "${LOGDIR:="../../exp/eval08-benchmarks/myssat/rawlog"}"                # folder to store raw log
: "${INFO_COLLECT_FILE:="../../exp/eval08-benchmarks/myssat/result.csv"}" # file to store this exp result
