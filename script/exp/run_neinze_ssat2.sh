...
: "${LOGDIR:="../../exp/eval08-benchmarks/nianze/rawlog"}"                # folder to store raw log
: "${INFO_COLLECT_FILE:="../../exp/eval08-benchmarks/nianze/result.csv"}" # file to store this exp result
